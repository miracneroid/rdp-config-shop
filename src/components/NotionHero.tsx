    ...
    <>
      <section className="relative w-full font-sans flex flex-col items-center justify-center min-h-[70vh] bg-white dark:bg-black pt-8 lg:pt-14 transition-colors">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center w-full z-10 relative px-4 lg:px-10">
          <div className="flex flex-col flex-1 items-start max-w-xl sm:mt-2 md:mt-8 w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#111827] dark:text-white leading-tight mb-4 sm:mb-6 tracking-tight font-sans">
              100%{" "}
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#2f323a] dark:text-[#eee] font-sans mb-5 sm:mb-7 max-w-lg">
          ...
          <div className="flex-1 flex justify-center items-center z-10 mt-8 md:mt-0 md:ml-8 lg:ml-14 w-full">
